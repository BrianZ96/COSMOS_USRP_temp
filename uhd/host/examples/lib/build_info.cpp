...
namespace uhd { namespace build_info {
    ...
    const std::string build_date() {
        return "Tue, 05 Apr 2022 20:53:19";
    }
    ...
    const std::string enabled_components() {
        return boost::algorithm::replace_all_copy(
            std::string("LibUHD;LibUHD - C API;Examples;Utils;Tests;USB;B100;B200;USRP1;USRP2;X300;N230;MPMD;N300;N320;E320;E300;OctoClock"),
