# Install script for directory: /home/srushti/workarea/uhd/host/utils/latency
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xutilitiesx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/uhd/utils/latency" TYPE EXECUTABLE FILES "/home/srushti/workarea/uhd/host/examples/utils/latency/responder")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/uhd/utils/latency/responder" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/uhd/utils/latency/responder")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/uhd/utils/latency/responder"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xutilitiesx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/uhd/utils/latency" TYPE PROGRAM FILES
    "/home/srushti/workarea/uhd/host/utils/latency/run_tests.py"
    "/home/srushti/workarea/uhd/host/utils/latency/graph.py"
    )
endif()
