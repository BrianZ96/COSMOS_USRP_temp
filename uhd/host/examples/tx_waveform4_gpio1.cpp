...
//	boost::this_thread::sleep_for(boost::chrono::nanoseconds(100));
	...
	boost::this_thread::sleep_for(boost::chrono::nanoseconds((unsigned long long)gpio_switching_samples)); //sampling period instead of gpio_switching_samples
...
//	std::cout<<"before"<<gpio789<<std::endl;
        usrp->clear_command_time();
	
        gpio789 = (gpio789+1)&7;
	//gpio789 = 4;
	//std::cout<<"after"<<gpio789<<std::endl;
    ...
    // finished
    std::cout << std::endl << "Doneeee!" << std::endl << std::endl;
    return EXIT_SUCCESS;
